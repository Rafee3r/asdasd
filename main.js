...
class CartItems extends HTMLElement {
  ...
  ["connectedCallback"]() {
    this.cartUpdateUnsubscriber = subscribe("cart-update", _0x49c801 => {
  ...
  ["updateQuantity"](_0x46259d, _0x41e498, _0xf227cb) {
    ...
    fetch('' + routes.cart_change_url, {
      ...
      this.classList.toggle("is-empty", _0x12b02a.item_count === 0x0);
      const _0x1ecbf8 = document.querySelector("cart-drawer");
      const _0x59cc79 = document.getElementById("main-cart-footer");
      if (_0x59cc79) {
        _0x59cc79.classList.toggle('is-empty', _0x12b02a.item_count === 0x0);
      }
      if (_0x1ecbf8) {
        _0x1ecbf8.classList.toggle("is-empty", _0x12b02a.item_count === 0x0);
      }
      ...
      const _0x3c2e9a = _0x12b02a.items[_0x46259d - 0x1] ? _0x12b02a.items[_0x46259d - 0x1].quantity : undefined;
      let _0x306a50 = '';
      ...
      if (_0x3c0996 && _0x3c0996.querySelector("[name=\"" + _0xf227cb + "\"]")) {
        ...
        if (_0x12b02a.item_count === 0x0 && _0x1ecbf8) {
        ...
        if (_0x1ecbf8.querySelector("cart-drawer-gift")) {
          ...
          _0x1ecbf8.querySelectorAll("cart-drawer-gift").forEach(_0x53866b => {
            if (_0x1ecbf8.querySelector('.cart-item--product-' + _0x53866b.dataset.handle)) {
              ...
              if (_0x53866b.dataset.selected === "true") {
                _0x53866b.addToCart();
              }
            }
          });
